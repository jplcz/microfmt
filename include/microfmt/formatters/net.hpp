...
[[nodiscard]] constexpr mac_view mac(span<const uint8_t> bytes,
                                     char separator = ':',
...
// From 6-byte C-array
[[nodiscard]] constexpr mac_view mac(const uint8_t (&arr)[6],
                                     char separator = ':',
                                     bool uppercase = false) noexcept {
...
[[nodiscard]] constexpr mac_view mac(const uint8_t (&arr)[8],
                                     char separator = ':',
                                     bool uppercase = false) noexcept {

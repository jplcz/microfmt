...
template <typename CharT, typename TraitsT> struct hash<microfmt::basic_string_view<CharT, TraitsT>> {
  [[nodiscard]] size_t operator()(microfmt::basic_string_view<CharT, TraitsT> value) const noexcept {

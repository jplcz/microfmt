...
struct unwind_hint {
   ...
   */
  using unwind_routine_t = bool (*)(address_space_ref space, uintptr_t current_fp, uintptr_t current_pc,
   ...
   */
  [[nodiscard]] constexpr bool contains(uintptr_t pc) const noexcept { return pc >= pc_start && pc < pc_end; }
};

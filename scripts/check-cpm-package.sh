...
readonly build_dir="${JPLCZ_MICROFMT_CPM_BUILD_DIR:-${source_dir}/build/cpm}"
readonly cpm_version="${JPLCZ_MICROFMT_CPM_VERSION:-0.43.1}"
readonly cpm_path="${JPLCZ_MICROFMT_CPM_PATH:-${build_dir}/CPM.cmake}"
...
cmake \
  ...
  "-DJPLCZ_MICROFMT_SOURCE_DIR=${source_dir}" \
  "$@"

...
MICROFMT_DEFINE_REGISTER_TYPE(UartIsr, uint32_t, MICROFMT_BIT_FLAG(0, "PE"), // Parity Error
...
int main() {
  ...
  static constexpr microfmt::bit_field GPIO_MODER_FIELDS[] = {
      MICROFMT_BIT_VALUE_DEC(0x3u << 0, 0, "PIN0"), MICROFMT_BIT_VALUE_DEC(0x3u << 2, 2, "PIN1"),
      MICROFMT_BIT_VALUE_DEC(0x3u << 4, 4, "PIN2"), MICROFMT_BIT_FLAG(31, "LOCK")};

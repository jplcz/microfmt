...
int main() {
  ...
  const microfmt::string_view at_apn = "AT+CGDCONT=1,\"IP\",\"internet.carrier.com\"\r";
  ...
  const char raw_nmea[] = "$GPGGA,123519,4807.038,N,01131.000,E,1,08,0.9,545.4,M,46.9,M,,*47\r\n";
  auto log_entry = microfmt::format<256>("[GPS][RX][len={}] raw={}", sizeof(raw_nmea) - 1,

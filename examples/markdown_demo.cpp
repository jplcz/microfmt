...
int main() {
  ...
  doc.h1("Firmware Diagnostics Report")
      .println("Generated automatically by **microfmt::md** on bare-metal target.")
      .newline();

  doc.blockquote("Target device: {} (MCU: {}) | Build ID: 0x{:08x}", "EdgeGateway-01", "STM32H743", 0xA1B2C3D4)
      .newline();

  doc.println("Use {}, {}, {}, and {} for readable diagnostics.", microfmt::md::bold("bold labels"),
              microfmt::md::italic("context"), microfmt::md::strike("obsolete values"),
              microfmt::md::code("register_name"));
  doc.println("Documentation: {}", microfmt::md::link("microfmt", "https://github.com/jplcz/microfmt"));
  doc.println("{}", microfmt::md::image("microfmt logo", "docs/microfmt-logo.svg")).newline();
  ...
  doc.alert(microfmt::md::admonition::warning, [](microfmt::md::writer &w) {
  ...
  const microfmt::md::column columns[] = {{"Sensor", 14, microfmt::md::align::left},
  ...
  const uint8_t crash_dump[] = {0x50, 0x41, 0x4e, 0x49, 0x43, 0x21, 0x00, 0x00, 0xef, 0xbe,
                                0xad, 0xde, 0x01, 0x02, 0x03, 0x04, 0x48, 0x61, 0x72, 0x64,
                                0x46, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x49, 0x53, 0x52};

  doc.hexdump_block("Expand the captured HardFault payload",

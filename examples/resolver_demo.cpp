...
template <> struct microfmt::symbol_resolver_traits<mock_kernel_symbol_tag> {
  ...
  static bool resolve(const void *ctx, uintptr_t addr,
...
int main() {
  ...
  static const mock_kernel_image_entry images[] = {
      ...
      {"nvgpu.ko", 0xffff'8000'0400'0000ULL, 0x0008'0000, nullptr,
       0}, // Stripped driver
  };
  ...
  microfmt::println("Exact Match   : {}",
                    microfmt::make_remote_symbol(0xffff'8000'0010'2000ULL,
                                                 resolver, scratch));

  // Symbol with offset (+0x18)
  microfmt::println("Symbol Offset : {}",
                    microfmt::make_remote_symbol(0xffff'8000'0010'2018ULL,
                                                 resolver, scratch));
  ...
  microfmt::println("Stripped Mod  : {}",
                    microfmt::make_remote_symbol(0xffff'8000'0401'4000ULL,
                                                 resolver, scratch));

  // Unmapped address
  microfmt::println("Unmapped      : {}",
                    microfmt::make_remote_symbol(0x0000'0000'0040'0000ULL,
                                                 resolver, scratch));

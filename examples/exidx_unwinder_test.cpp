...
int main() {
  ...
  stack_region[0] = static_cast<uint32_t>(stack_base + 16); // Caller FP (points to Frame 1)
  ...
  microfmt::symbol_resolver_ref resolver = microfmt::symbol_resolver_ref::make<exidx_demo_sym_tag>();

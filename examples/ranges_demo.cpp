...
int main() {
  ...
  const microfmt::string_view breadcrumbs[] = {"sys", "bus", "i2c", "devices", "0-0048"};
  ...
  const char *const sensor_names[] = {"BMP280", "MPU6050", "INA219", "MAX31865"};
  ...
  const microfmt::milli_view<int32_t> voltages[] = {microfmt::milli(3305), microfmt::milli(1812), microfmt::milli(1198),
                                                    microfmt::milli(5004)};
  ...
  auto msg = microfmt::format<128>("Device MAC: [{}] (Length: {} bytes)", microfmt::join_as<":", "02X">(mac_raw),
                                   sizeof(mac_raw));

...
| [Micro VM bytecode scripting](inspector/micro-vm.md) | A zero-allocation stack-machine interpreter and bytecode generator for scripted register/memory expressions, fault-safe target access, and formatted output | `micro_vm.hpp`, `vm_code_gen.hpp` |

...
| [GDB Remote Serial Protocol](inspector/gdb-protocol.md) | Request and response payloads, packet recognition, binary escaping, checksums, and streaming framing | `gdb_encoders.hpp`, `gdb_decoders.hpp`, `gdb_stream.hpp` |

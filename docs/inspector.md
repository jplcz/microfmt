...
| [Metadata maps](inspector/metadata.md) | Fixed-capacity heterogeneous properties, type-erased generators, formatting, and lifetime requirements | `metadata_map.hpp`, `concrete_metadata_map.hpp`, `reloco.hpp` |

...
| [Ranges and structured values](formatters/ranges-and-structures.md) | Joined and filtered ranges, tuples, maps, grids, vectors, matrices, monads, and reflected types | `filter_view.hpp`, `grid_view.hpp`, `map_view.hpp`, `math.hpp`, `monad.hpp`, `ranges.hpp`, `tuple.hpp`, `boost_describe.hpp` |

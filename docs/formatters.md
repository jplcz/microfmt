...
| [Ranges and structured values](formatters/ranges-and-structures.md) | Joined and filtered ranges, tuples, maps, grids, vectors, matrices, monads, reflected types, and Boost integrations | `filter_view.hpp`, `grid_view.hpp`, `map_view.hpp`, `math.hpp`, `monad.hpp`, `ranges.hpp`, `tuple.hpp`, `boost_describe.hpp`, `boost_containers.hpp`, `boost_monad.hpp`, `boost_net.hpp`, `boost_system.hpp`, `boost_time.hpp`, `boost_values.hpp` |
